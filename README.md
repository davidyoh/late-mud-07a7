...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/late-mud-07a7)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/late-mud-07a7
```

A live public deployment of this template is available at [https://late-mud-07a7.templates.workers.dev](https://late-mud-07a7.templates.workers.dev)
